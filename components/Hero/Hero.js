                    ...
                    <div className="row">
                        <div className="col-12 col-md-6 col-lg-7">
                            ...
                            <div className="button-group">
                                <a className="btn btn-bordered-white" href="/explore-1"><i className="icon-rocket me-2" />{this.state.data.btn_1}</a>
                                <a className="btn btn-bordered-white" href="/create"><i className="icon-note me-2" />{this.state.data.btn_2}</a>
                            </div>
                        </div>
                    </div>
                </div>
